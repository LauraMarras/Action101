...
if __name__ == '__main__':
    ...
    domains_ds_bin = get_domain_mat(group_downsampled, domains, out_path+'domains/', 'group_ds_binary')
    domains_ds_conv = get_domain_mat(group_conv_ds, domains, out_path+'domains/', 'group_ds_conv')
